...
class AudioFile():
    ...
    def get_params(self):
        ...
        self.write_location = os.path.join(self.write_path, self.home + '-' + self.sensor + '-audio-npz')
    ...
    def save_object(self, entry, fname, day_loc):
                            ...
                            for minute in sorted(this_hr):
                                for wav_file in sorted(self.mylistdir(os.path.join(self.path, day, minute))):
                                    ...
                                    try:
                                        ...
                                        curr_file = [str_day, str_time, audio_list]
                                        hr_entry.append(curr_file)
